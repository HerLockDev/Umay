...
REPO_URL = "https://github.com/HerLockDev/UmayUserBot"
LANG = LANG['MAIN']
...
if __name__ == "__main__":
    ...
    config['DEFAULT_BIO'] = "@UmayUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/HerLockDev/UmayUserBot"
    config['WARN_LIMIT'] = "3"
